...
public class RPGGenerator extends AbstractGenerator {
  ...
  public CharSequence generateGame(final String classFileName) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private final int membersFighting = 2;");
    _builder.newLine();
    _builder.append("    ");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("int entitiesLeft = membersFighting;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if(entities.size() < membersFighting) entitiesLeft = entities.size();");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t\t");
