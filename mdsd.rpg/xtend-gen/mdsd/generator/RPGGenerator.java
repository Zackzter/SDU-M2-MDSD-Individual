...
public class RPGGenerator extends AbstractGenerator {
  ...
  public CharSequence generateGame(final String classFileName) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("int teamsBeaten = 0;");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("teamsBeaten++;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("if(lost) break;");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("if(location.getLocations().size() == teamsBeaten && !lost){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("// Sort the speed values");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("if(playerNameID.containsValue(targetEntity) && fightingEntity.getEntityState().equals(EntityState.ALIVE)){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("else if(enemyNameID.containsValue(targetEntity) && fightingEntity.getEntityState().equals(EntityState.ALIVE)){");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
