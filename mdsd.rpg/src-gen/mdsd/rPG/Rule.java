...
public interface Rule extends AttributeValues
{
  ...
  /**
   * Returns the value of the '<em><b>Carl</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the value of the '<em>Carl</em>' containment reference.
   * @see #setCarl(Carl)
  ...
  /**
   * Sets the value of the '{@link mdsd.rPG.Rule#getCarl <em>Carl</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Carl</em>' containment reference.
   * @see #getCarl()
   * @generated
   */
  void setCarl(Carl value);
