 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.MovesImpl#getMove <em>Move</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MovesImpl extends DeclarationImpl implements Moves
{
  ...
  {
    return MyDslPackage.Literals.MOVES;
  }
  ...
  public EList<Move> getMove()
  {
    if (move == null)
    {
      move = new EObjectContainmentEList<Move>(Move.class, this, MyDslPackage.MOVES__MOVE);
    }
    return move;
  }
