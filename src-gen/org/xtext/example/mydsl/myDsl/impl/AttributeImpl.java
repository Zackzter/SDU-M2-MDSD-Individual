 ...
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.AttributeImpl#getAVal <em>AVal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute
{
  ...
  public NotificationChain basicSetAVal(AttributeValues newAVal, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ATTRIBUTE__AVAL, oldAVal, newAVal);
  ...
  public void setAVal(AttributeValues newAVal)
  {
    if (newAVal != aVal)
    {
      ...
      if (aVal != null)
        msgs = ((InternalEObject)aVal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ATTRIBUTE__AVAL, null, msgs);
      if (newAVal != null)
        msgs = ((InternalEObject)newAVal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ATTRIBUTE__AVAL, null, msgs);
      msgs = basicSetAVal(newAVal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ATTRIBUTE__AVAL, newAVal, newAVal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ATTRIBUTE__AVAL:
