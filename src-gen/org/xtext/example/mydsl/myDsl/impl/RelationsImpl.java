 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.RelationsImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelationsImpl extends DeclarationImpl implements Relations
{
  ...
  {
    return MyDslPackage.Literals.RELATIONS;
  }
  ...
  public EList<Type> getType()
  {
    if (type == null)
    {
      type = new EObjectContainmentEList<Type>(Type.class, this, MyDslPackage.RELATIONS__TYPE);
    }
    return type;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.RELATIONS__TYPE:
