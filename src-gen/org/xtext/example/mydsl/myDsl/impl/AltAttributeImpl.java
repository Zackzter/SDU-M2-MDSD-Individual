 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.AltAttributeImpl#getAttriburte <em>Attriburte</em>}</li>
 *   <li>{@link org.xtext.example.mydsl.myDsl.impl.AltAttributeImpl#getAv <em>Av</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AltAttributeImpl extends MinimalEObjectImpl.Container implements AltAttribute
{
  ...
  {
    return MyDslPackage.Literals.ALT_ATTRIBUTE;
  }
  ...
  public EList<Attribute> getAttriburte()
  {
    if (attriburte == null)
    {
      attriburte = new EObjectResolvingEList<Attribute>(Attribute.class, this, MyDslPackage.ALT_ATTRIBUTE__ATTRIBURTE);
    }
    return attriburte;
  }
  ...
  public NotificationChain basicSetAv(AttributeValues newAv, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MyDslPackage.ALT_ATTRIBUTE__AV, oldAv, newAv);
  ...
  public void setAv(AttributeValues newAv)
  {
    if (newAv != av)
    {
      ...
      if (av != null)
        msgs = ((InternalEObject)av).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ALT_ATTRIBUTE__AV, null, msgs);
      if (newAv != null)
        msgs = ((InternalEObject)newAv).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MyDslPackage.ALT_ATTRIBUTE__AV, null, msgs);
      msgs = basicSetAv(newAv, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, MyDslPackage.ALT_ATTRIBUTE__AV, newAv, newAv));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MyDslPackage.ALT_ATTRIBUTE__AV:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case MyDslPackage.ALT_ATTRIBUTE__ATTRIBURTE:
